...
// tests for CouponDetail
void main() {
  // final instance = CouponDetail();

  group('test CouponDetail', () {
    // int couponId
    ...
    // int loyalCustomerId
    test('to test the property `loyalCustomerId`', () async {
      // TODO
    });
    ...
    // Promotion promotion
    test('to test the property `promotion`', () async {
      // TODO
    });

    // List<CouponLink> links (default value: const [])
