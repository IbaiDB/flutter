...
class CouponIssuanceKey {
  /// Returns a new [CouponIssuanceKey] instance.
  CouponIssuanceKey({
    this.couponKey,
    this.keyStartDate,
    this.keyEndDate,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CouponIssuanceKey &&
  ...
  @override
  String toString() => 'CouponIssuanceKey[couponKey=$couponKey, keyStartDate=$keyStartDate, keyEndDate=$keyEndDate, active=$active, maxUses=$maxUses, vigenceDays=$vigenceDays, couponName=$couponName, couponDescription=$couponDescription, manualSelection=$manualSelection, couponTypeCode=$couponTypeCode, promotionId=$promotionId, priority=$priority, balance=$balance, imageUrl=$imageUrl]';
  ...
  /// Returns a new [CouponIssuanceKey] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CouponIssuanceKey? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CouponIssuanceKey[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CouponIssuanceKey[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CouponIssuanceKey(
  ...
  static List<CouponIssuanceKey> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CouponIssuanceKey>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CouponIssuanceKey.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CouponIssuanceKey> mapFromJson(dynamic json) {
    final map = <String, CouponIssuanceKey>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CouponIssuanceKey.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CouponIssuanceKey-objects as value to a dart map
  static Map<String, List<CouponIssuanceKey>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CouponIssuanceKey>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CouponIssuanceKey.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
