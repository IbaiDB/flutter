...
class Coupon {
  ...
  @override
  String toString() => 'Coupon[couponId=$couponId, couponCode=$couponCode, couponName=$couponName, couponDescription=$couponDescription, startDate=$startDate, endDate=$endDate, manualSelection=$manualSelection, promotionId=$promotionId, priority=$priority, balance=$balance, imageUrl=$imageUrl, active=$active, creationDate=$creationDate]';
