...
class NewCardRequest {
  /// Returns a new [NewCardRequest] instance.
  NewCardRequest({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NewCardRequest &&
  ...
  @override
  String toString() => 'NewCardRequest[cardNumber=$cardNumber, issueDate=$issueDate, cardAccountId=$cardAccountId, activationDate=$activationDate, lastUseDate=$lastUseDate, deactivationDate=$deactivationDate, lyCustomerId=$lyCustomerId, lyCustAssignmentDate=$lyCustAssignmentDate, cardTypeCode=$cardTypeCode]';
  ...
  /// Returns a new [NewCardRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NewCardRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NewCardRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NewCardRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<NewCardRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewCardRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NewCardRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NewCardRequest> mapFromJson(dynamic json) {
    final map = <String, NewCardRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NewCardRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NewCardRequest-objects as value to a dart map
  static Map<String, List<NewCardRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NewCardRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NewCardRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
