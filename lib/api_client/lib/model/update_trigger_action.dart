...
class UpdateTriggerAction {
  /// Returns a new [UpdateTriggerAction] instance.
  UpdateTriggerAction({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateTriggerAction &&
  ...
  @override
  String toString() => 'UpdateTriggerAction[actionType=$actionType, manualExecution=$manualExecution, nextExecutionDate=$nextExecutionDate, timeInterval=$timeInterval, cronInterval=$cronInterval, lastActionExecUid=$lastActionExecUid, triggerUid=$triggerUid, actionData=$actionData]';
  ...
  /// Returns a new [UpdateTriggerAction] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UpdateTriggerAction? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateTriggerAction[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateTriggerAction[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdateTriggerAction> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UpdateTriggerAction>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UpdateTriggerAction.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UpdateTriggerAction> mapFromJson(dynamic json) {
    final map = <String, UpdateTriggerAction>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateTriggerAction.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UpdateTriggerAction-objects as value to a dart map
  static Map<String, List<UpdateTriggerAction>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdateTriggerAction>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UpdateTriggerAction.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
