...
class TriggerExecutionDataDetail {
  /// Returns a new [TriggerExecutionDataDetail] instance.
  TriggerExecutionDataDetail({
    this.triggerExecUid,
    this.lyCustomerId,
    this.lyCustomerCode,
    this.name,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TriggerExecutionDataDetail &&
  ...
  /// Returns a new [TriggerExecutionDataDetail] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TriggerExecutionDataDetail? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TriggerExecutionDataDetail[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TriggerExecutionDataDetail[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return TriggerExecutionDataDetail(
  ...
  static List<TriggerExecutionDataDetail> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TriggerExecutionDataDetail>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TriggerExecutionDataDetail.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TriggerExecutionDataDetail> mapFromJson(dynamic json) {
    final map = <String, TriggerExecutionDataDetail>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TriggerExecutionDataDetail.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TriggerExecutionDataDetail-objects as value to a dart map
  static Map<String, List<TriggerExecutionDataDetail>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TriggerExecutionDataDetail>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TriggerExecutionDataDetail.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
