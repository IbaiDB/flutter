...
class CardDetail {
  /// Returns a new [CardDetail] instance.
  CardDetail({
    this.cardId,
    this.cardNumber,
    this.issueDate,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CardDetail &&
    other.cardId == cardId &&
  ...
  int get hashCode =>
    ...
    (lyCustomer == null ? 0 : lyCustomer!.hashCode) +
    (cardType == null ? 0 : cardType!.hashCode) +
    (account == null ? 0 : account!.hashCode);

  @override
  String toString() => 'CardDetail[cardId=$cardId, cardNumber=$cardNumber, issueDate=$issueDate, activationDate=$activationDate, lastUseDate=$lastUseDate, deactivationDate=$deactivationDate, lyCustAssignmentDate=$lyCustAssignmentDate, lyCustomer=$lyCustomer, cardType=$cardType, account=$account]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.lyCustomer != null) {
      json[r'lyCustomer'] = this.lyCustomer;
    } else {
      json[r'lyCustomer'] = null;
    }
  ...
  /// Returns a new [CardDetail] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CardDetail? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CardDetail[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CardDetail[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CardDetail(
        ...
        lyCustomer: Customer.fromJson(json[r'lyCustomer']),
  ...
  static List<CardDetail> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CardDetail>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CardDetail.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CardDetail> mapFromJson(dynamic json) {
    final map = <String, CardDetail>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CardDetail.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CardDetail-objects as value to a dart map
  static Map<String, List<CardDetail>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CardDetail>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CardDetail.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
